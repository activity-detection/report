...
\begin{itemize}
\item \textbf{Nginx} - pełni rolę reverse proxy, kierując ruch do odpowiednich usług w zależności od ścieżki URL. Umożliwia wdrożenie certyfikatu SSL i komunikację poprzez protokół HTTPS.
\item \textbf{Frontend} - aplikacja webowa zbudowana w Next.js, odpowiedzialna za interfejs użytkownika, wizualizację danych oraz interakcję z backendem.

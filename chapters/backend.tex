...
\begin{figure}[H]
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.4\linewidth]{images/backend/przykladowy_stan_dysku_po_zapisie.png}
    ...
    \begin{subfigure}{\textwidth}
        \centering
        \includegraphics[width=0.95\linewidth]{images/backend/przykladowy_stan_mapowan_w_bazie.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/backend/diagram_backend.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/backend/przykladowa_sekwencja.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{images/backend/przykladowe_zapytanie_zapisu_do_backendu.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{images/backend/Diagram_DASH.png}
